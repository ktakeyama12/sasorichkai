...
<div class="slider">
  ...
  <div class="slider__inner">
    <div class="slider__contents"><i><img src="images/rakuten_circle.jpg" alt="rakuten circle" /></i>
      ...
      <p class="slider__txt">配属後どこに行っても<br>困らないように<br>楽天理解度を深めておいて<br>損はない！<br><br>Rポイントで<br>楽天理解度を図りましょう！<br></p>
    </div>
    ...
    <div class="slider__contents"><i><img src="images/games.png" alt="rakuten circle" /></i>
      ...
      <p class="slider__txt">ポイントの貯め方はとっても簡単！楽天プライムのコンテンツを購読したり、ゲームやクイズで遊ぶだけ！<br><br>他にもいろいろな方法でどんどん貯められます。</p>
    </div>
